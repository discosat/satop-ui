...
export const mockUsers: User[] = [
  {
    ...
    role: "ADMIN",
    additionalRoles: [],
    additionalScopes: ["flight:approve", "user:manage"],
  ...
  },
  {
    ...
    role: "OPERATOR",
    additionalRoles: ["ground-station:manage"],
    additionalScopes: ["flight:create", "flight:edit"],
  ...
  },
  {
    ...
    role: "OPERATOR",
    additionalRoles: [],
    additionalScopes: ["satellite:manage", "flight:create"],
